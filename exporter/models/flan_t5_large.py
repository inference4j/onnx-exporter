...
class FlanT5Large(ExportedModel):
    name = "flan-t5-large"
    repo_id = "inference4j/flan-t5-large"
    source_repo = "google/flan-t5-large"
    ...
    def stage(self, staging_dir: Path) -> None:
        ...
        print("  Exporting Flan-T5 Large to ONNX (encoder-decoder with KV cache)...")
        main_export(
...
ONNX export of [Flan-T5 Large](https://huggingface.co/google/flan-t5-large) \
...
- **Repository:** [google/flan-t5-large](https://huggingface.co/google/flan-t5-large)
- **License:** Apache 2.0
