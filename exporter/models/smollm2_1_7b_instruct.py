...
class SmolLM2_1_7B_Instruct(ExportedModel):
    name = "smollm2-1.7b-instruct"
    repo_id = "inference4j/smollm2-1.7b-instruct"
    ...
    def stage(self, staging_dir: Path) -> None:
        ...
        print("  Exporting SmolLM2-1.7B-Instruct to ONNX (FP16) with KV cache...")
        main_export(
...
# SmolLM2-1.7B-Instruct — ONNX (FP16)

ONNX export of [SmolLM2-1.7B-Instruct](https://huggingface.co/HuggingFaceTB/SmolLM2-1.7B-Instruct) \
(1.7B parameters, FP16 weights) with KV cache support for efficient autoregressive generation.
...
- **Repository:** [HuggingFaceTB/SmolLM2-1.7B-Instruct](https://huggingface.co/HuggingFaceTB/SmolLM2-1.7B-Instruct)
- **License:** Apache 2.0
...
register(SmolLM2_1_7B_Instruct())
